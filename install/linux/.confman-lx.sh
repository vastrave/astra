...
# $usrm=
   read -r -p "  1. Modern" th1
     if $th1; then
     echo -e "  ! Would you like to install: \033[1;34mModern\033[0m?"
     # $tcd
     read
     sleep 0.8
     echo -e "  ! Your preference has been saved. astra will install as [\033[1;34mModern\033[0m] later."
     fi
   ...
   read -r -p "  1. AMD" gc1
     if $gc1; then
     echo -e "  ! Is this correct?: \033[0;31mAMD\033[0m"
     # $gcd
     read
     sleep 0.8
     echo -e "    Understood. Saved graphics card as \033[0;31mAMD\033[0m."
     fi
